...
function destroiAviao()
      ...
      aviao_14bis.src = "explosao_nave.png"
...
function checaColisaoComAviao()
   for k,meteoro in pairs(meteoros) do 
      if temColisao(meteoro.x, meteoro.y, meteoro.largura, meteoro.altura, aviao_14bis.x, aviao_14bis.y, aviao_14bis.largura,
...
function love.load()
    ...
    love.window.setTitle("14bs vs Meteoros")

    math.random(os.time())

    background = love.graphics.newImage("background.png")
    gameover_img = love.graphics.newImage("gameover.png")
    vencedor_img = love.graphics.newImage("vencedor.png")


    aviao_14bis.imagem = love.graphics.newImage(aviao_14bis.src)
    meteoro_img = love.graphics.newImage("meteoro.png")
    tiro_img = love.graphics.newImage("tiro.png")
